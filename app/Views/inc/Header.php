...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container"><a class="navbar-brand" href="<?php echo _WEB_ROOT; ?>"><img src="<?php echo _WEB_ROOT; ?>/public/img/gallery/logo.png" width="118" alt="logo" /></a>
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
            ...
            <li style="margin-top: -5px;" class="nav-item px-2 "><a class="nav-link" href="<?php echo _WEB_ROOT; ?>/home/appointment"><i style="font-size: 22px;" class="bi bi-calendar3 m-1"></i><span>Đặt lịch</span></a></li>
            ...
            <?php if (isset($_SESSION['is_login'])) { ?>
              <li class="nav-item px-2">
                <button type="button" data-toggle="collapse" data-target="#userProfile" aria-expanded="false" aria-controls="userProfile">
                  <img src="<?php echo _WEB_ROOT; ?>/public/img/users/<?php echo $_SESSION['is_login']['image'] ?>" alt="" width="40px"  style="border-radius: 50%; height: 40px;">
                </button>
              </li>
            <?php  } else { ?>
              <li class="nav-item px-2 mb-2"><a class="nav-link badge bg-secondary rounded text-light p-2" href="<?php echo _WEB_ROOT; ?>/account/login">Đăng
                  nhập</a></li>
              <li class="nav-item px-2"><a class="nav-link badge bg-danger rounded text-light p-2" href="<?php echo _WEB_ROOT; ?>/account/register">Đăng
                  kí</a></li>
            <?php } ?>
          </ul>

          <div class="collapse multi-collapse " id="userProfile" class="collapse p-3 shadow-sm p-3 mb-5 bg-body" style="position: absolute; top: 60px; width: 250px; right: 20px; background-color: #fff; border-radius: 10px; box-shadow: 1px 2px 3px #000;">
            <div class="text-start text-dark border-bottom" >
              <img class="m-2" src="<?php echo _WEB_ROOT; ?>/public/img/users/<?php echo $_SESSION['is_login']['image'] ?>" alt="" width="40px" style="border-radius: 50%; height: 40px;">
              <span class="" style="font-size: 14px;"><?php echo $_SESSION['is_login']['fullname'] ?></span>
