...
<div class="section__content section__content--p30">
    ...
    <div class="container-fluid">
        ...
        <div class="section__content section__content--p30">
            ...
            <a class="btn btn-primary" href="<?php echo _WEB_ROOT ?>/admin/listUsersPatient">Danh sách bệnh nhân</a>
                                ...
                                foreach ($listPatientDelete as $index => $patient) { ?>
                                    ...
                                    <td id="row<?php echo $staff['id_patient']; ?>"></td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary" href="<?php echo _WEB_ROOT ?>/admin/restorePatient/<?php echo $patient['id_patient'] ?>">Khôi phục</a>
