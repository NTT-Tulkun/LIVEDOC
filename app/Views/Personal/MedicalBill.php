...
<body>
    ...
    <div class="container border p-4 mt-3">
        ...
        <form action="<?php echo _WEB_ROOT; ?>/Personal/prescription" method="POST">
            <div class="form-group row">
                <div class="col-sm-12 col-md-6">
                    <label for="hoTen">Họ và Tên:</label>
                    <input type="text" class="border-0" name="hoten" placeholder="Nhập họ và tên..." style="outline: none;">
                </div>

                <div class="col-sm-12 col-md-6">
                    <label for="ngaySinh">Ngày Sinh:</label>
                    <input type="text" class="border-0" name="ngaysinh" value="" placeholder="Nhập ngày sinh..." style="outline: none;">
                </div>
            </div>

            <div class="form-group">
                <label for="điện thoại">Điện thoại:</label>
                <input type="number" class="border-0" name="dienthoai" value="" placeholder="Nhập số điện thoại..." style="outline: none;">
            </div>

            <div class="form-group">
                <label for="trieuChung">Email:</label>
                <input type="text" class="border-0" name="email" value="" placeholder="Nhập email..." style="outline: none;">
            </div>

            <div class="form-group">
                <label for="trieuChung">Giới tính:</label>
                <input type="text" class="border-0" value="" name="gender" placeholder="Nhập giới tính..." style="outline: none;">
            </div>
